  ...
  return (
    <>
      ...
      <div
        ...
        style={{ paddingBottom: '5%', width: '50%' }}
      >
        <div
          className="container-fluid"
                  ...
                  Object.keys(response).map((key, index) => {
                    return (
                      <div key={key}>
                        ...
                        <CardComponent
                          component_name={
                            response[index]?.datasheet?.information
                              ?.component_name
                          }
                          description={
                            response[index]?.datasheet?.information?.description
                          }
                          provider={
                            response[index]?.datasheet?.information?.provider
                          }
                          version={
                            response[index]?.datasheet?.information?.version
                          }
